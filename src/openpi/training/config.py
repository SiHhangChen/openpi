...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_membench_wa01_3view_lora",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotMemBenchDataConfig(
            repo_id="wa01_200seeds_v061",
            assets=AssetsConfig(assets_dir="./assets/pi05_membench_wa01_lora"),
            state_keep_dim=30,
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
    ...
    TrainConfig(
        # Standard pi0.5 fine-tuning on the TS01 episode-level task prompt.
        # This is deliberately separate from memer_ts01, which consumes
        # per-frame subtask prompts and therefore expects a different dataset.
        name="pi05_membench_ts01_lora",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotMemBenchDataConfig(
            repo_id=os.getenv("DATASET_REPO_ID", "ts01_200seeds_v061"),
            state_keep_dim=30,
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(_local_pretrain_params("pi05_base")),
    ...
    TrainConfig(
        name="pi05_membench_ts01_3view_lora",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotMemBenchDataConfig(
            repo_id="ts01_200seeds_v061",
            assets=AssetsConfig(assets_dir="./assets/pi05_membench_ts01_lora"),
            state_keep_dim=30,
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
    ...
    TrainConfig(
        # WA-05: fill the cup with hot or cold water, place it in the service area,
        # then press the matching (red=hot / blue=cold) answer button. Fully
        # isomorphic to the WA-01 / WR-04 pipeline (LeRobot v3.0, mobile_manipulator,
        # state[37]/action[13], three 224x224 RGB cameras). state_keep_dim=30 drops the
        # trailing 7-dim eef slice, matching the pi05 pretrain state distribution.
        name="pi05_membench_wa05_lora",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
    ...
    TrainConfig(
        name="pi05_membench_wa05_3view_lora",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotMemBenchDataConfig(
            repo_id="wa05_200seeds_v061",
            assets=AssetsConfig(assets_dir="./assets/pi05_membench_wa05_lora"),
            state_keep_dim=30,
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
    ...
    TrainConfig(
        ...
        data=LeRobotMemBenchDataConfig(
            repo_id=os.getenv("DATASET_REPO_ID", "ts02_200seeds_v061"),
            state_keep_dim=30,
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(_local_pretrain_params("pi05_base")),
    ...
    TrainConfig(
        name="pi05_membench_ts02_3view_lora",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotMemBenchDataConfig(
            repo_id=os.getenv("DATASET_REPO_ID", "ts02_compact_return_arm_200seeds_v061"),
            assets=AssetsConfig(assets_dir="./assets/pi05_membench_ts02_lora"),
            state_keep_dim=30,
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
    ...
    TrainConfig(
        ...
        # WA02 is trained independently from the pi05 base model.
        weight_loader=weight_loaders.CheckpointWeightLoader(_local_pretrain_params("pi05_base")),
        freeze_filter=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
